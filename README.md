...
![Adobe After Effects](https://img.shields.io/badge/Adobe-After%20Effects-9999FF?logo=adobeaftereffects&logoColor=white)
...
- Using [Waifu2x](https://github.com/nagadomi/waifu2x.git) extension in After Effects 
...
- 🔧 Works natively in After Effects scripting system (JSX)  
- 💾 Zero dependencies — simple plug-and-run  
